...
public final class CentralSystem extends OCPPOperations{
    ...
    protected String handlerType(String source) {
        return String.format("%s.usecase.%s.CentralSystemHandler", rootPackage, source);
    }
    ...
    public void register(CentralSystemHandler handler) {
    ...
    public void offer(CentralSystemFeature feature, OCPPConsumer<OCPPMessage<?>> consumer) {
        super.offer(()->{ 
            return feature;
        }, consumer);
    }
