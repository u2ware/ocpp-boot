...
public interface RemoteStartTransaction {
    ...
    public static Specification.Section section = Specification.InitiatedByCentralSystem.Usecase.RemoteStartTransaction;
    ...
    public static enum Comment {
        ...
        receivedRemoteStartTransactionRequest,
        receivedRemoteStartTransactionResponse,
        sendRemoteStartTransactionResponse
        ;
    ...
    public interface ServerHandler extends RemoteStartTransaction, RemoteStartTransactionOffer {
    ...
    public interface ClientHandler extends RemoteStartTransaction, RemoteStartTransactionAnswer {
