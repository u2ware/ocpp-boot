...
import io.u2ware.ocpp.v2_1.actions.GetBaseReportOffer;
import io.u2ware.ocpp.v2_1.actions.GetBaseReportAnswer;
...
public interface GetBaseReport {
    ...
    public interface CSMSHandler extends GetBaseReportOffer, io.u2ware.ocpp.v2_1.messaging.CSMSHandler {
    ...
    public interface ChargingStationHandler extends GetBaseReportAnswer, io.u2ware.ocpp.v2_1.messaging.ChargingStationHandler {    
