...
import io.u2ware.ocpp.v2_1.actions.SignCertificateOffer;
import io.u2ware.ocpp.v2_1.actions.SignCertificateAnswer;
...
public interface SignCertificate {
    ...
    public interface ChargingStationHandler extends SignCertificateOffer, io.u2ware.ocpp.v2_1.messaging.ChargingStationHandler {
    ...
    public interface CSMSHandler extends SignCertificateAnswer, io.u2ware.ocpp.v2_1.messaging.CSMSHandler {    
