...
import io.u2ware.ocpp.v2_1.actions.AuthorizeOffer;
import io.u2ware.ocpp.v2_1.actions.AuthorizeAnswer;
...
public interface Authorize {
    ...
    public interface ChargingStationHandler extends AuthorizeOffer, io.u2ware.ocpp.v2_1.messaging.ChargingStationHandler {
    ...
    public interface CSMSHandler extends AuthorizeAnswer, io.u2ware.ocpp.v2_1.messaging.CSMSHandler {    
