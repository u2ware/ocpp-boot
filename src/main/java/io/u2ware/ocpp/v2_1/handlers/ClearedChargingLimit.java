...
import io.u2ware.ocpp.v2_1.actions.ClearedChargingLimitOffer;
import io.u2ware.ocpp.v2_1.actions.ClearedChargingLimitAnswer;
...
public interface ClearedChargingLimit {
    ...
    public interface ChargingStationHandler extends ClearedChargingLimitOffer, io.u2ware.ocpp.v2_1.messaging.ChargingStationHandler {

        default String[] features() { return new String[]{"ClearedChargingLimit"};}
    ...
    public interface CSMSHandler extends ClearedChargingLimitAnswer, io.u2ware.ocpp.v2_1.messaging.CSMSHandler {    
