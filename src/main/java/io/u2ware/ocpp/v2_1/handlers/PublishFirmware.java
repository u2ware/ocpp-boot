...
import io.u2ware.ocpp.v2_1.actions.PublishFirmwareOffer;
import io.u2ware.ocpp.v2_1.actions.PublishFirmwareAnswer;
...
public interface PublishFirmware {
    ...
    public interface CSMSHandler extends PublishFirmwareOffer, io.u2ware.ocpp.v2_1.messaging.CSMSHandler {
    ...
    public interface ChargingStationHandler extends PublishFirmwareAnswer, io.u2ware.ocpp.v2_1.messaging.ChargingStationHandler {    
