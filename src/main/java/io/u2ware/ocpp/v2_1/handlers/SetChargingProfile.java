...
import io.u2ware.ocpp.v2_1.actions.SetChargingProfileOffer;
import io.u2ware.ocpp.v2_1.actions.SetChargingProfileAnswer;
...
public interface SetChargingProfile {
    ...
    public interface CSMSHandler extends SetChargingProfileOffer, io.u2ware.ocpp.v2_1.messaging.CSMSHandler {
    ...
    public interface ChargingStationHandler extends SetChargingProfileAnswer, io.u2ware.ocpp.v2_1.messaging.ChargingStationHandler {    
