...
import io.u2ware.ocpp.v2_1.actions.SetVariablesOffer;
import io.u2ware.ocpp.v2_1.actions.SetVariablesAnswer;
...
public interface SetVariables {
    ...
    public interface CSMSHandler extends SetVariablesOffer, io.u2ware.ocpp.v2_1.messaging.CSMSHandler {
    ...
    public interface ChargingStationHandler extends SetVariablesAnswer, io.u2ware.ocpp.v2_1.messaging.ChargingStationHandler {    
