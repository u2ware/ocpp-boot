...
import io.u2ware.ocpp.v2_1.actions.SetMonitoringBaseOffer;
import io.u2ware.ocpp.v2_1.actions.SetMonitoringBaseAnswer;
...
public interface SetMonitoringBase {
    ...
    public interface CSMSHandler extends SetMonitoringBaseOffer, io.u2ware.ocpp.v2_1.messaging.CSMSHandler {

        default String[] features() { return new String[]{"SetMonitoringBase"};}
    ...
    public interface ChargingStationHandler extends SetMonitoringBaseAnswer, io.u2ware.ocpp.v2_1.messaging.ChargingStationHandler {    
