...
import io.u2ware.ocpp.v2_1.actions.UnpublishFirmwareOffer;
import io.u2ware.ocpp.v2_1.actions.UnpublishFirmwareAnswer;
...
public interface UnpublishFirmware {
    ...
    public interface CSMSHandler extends UnpublishFirmwareOffer, io.u2ware.ocpp.v2_1.messaging.CSMSHandler {
    ...
    public interface ChargingStationHandler extends UnpublishFirmwareAnswer, io.u2ware.ocpp.v2_1.messaging.ChargingStationHandler {    
