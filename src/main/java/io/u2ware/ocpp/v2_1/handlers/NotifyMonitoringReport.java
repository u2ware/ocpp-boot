...
import io.u2ware.ocpp.v2_1.actions.NotifyMonitoringReportOffer;
import io.u2ware.ocpp.v2_1.actions.NotifyMonitoringReportAnswer;
...
public interface NotifyMonitoringReport {
    ...
    public interface ChargingStationHandler extends NotifyMonitoringReportOffer, io.u2ware.ocpp.v2_1.messaging.ChargingStationHandler {
    ...
    public interface CSMSHandler extends NotifyMonitoringReportAnswer, io.u2ware.ocpp.v2_1.messaging.CSMSHandler {    
