...
import io.u2ware.ocpp.v2_1.actions.MeterValuesOffer;
import io.u2ware.ocpp.v2_1.actions.MeterValuesAnswer;
...
public interface MeterValues {
    ...
    public interface ChargingStationHandler extends MeterValuesOffer, io.u2ware.ocpp.v2_1.messaging.ChargingStationHandler {
    ...
    public interface CSMSHandler extends MeterValuesAnswer, io.u2ware.ocpp.v2_1.messaging.CSMSHandler {    
