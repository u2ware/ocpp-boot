...
import io.u2ware.ocpp.v2_1.actions.SetVariableMonitoringOffer;
import io.u2ware.ocpp.v2_1.actions.SetVariableMonitoringAnswer;
...
public interface SetVariableMonitoring {
    ...
    public interface CSMSHandler extends SetVariableMonitoringOffer, io.u2ware.ocpp.v2_1.messaging.CSMSHandler {

        default String[] features() { return new String[]{"SetVariableMonitoring"};}
    ...
    public interface ChargingStationHandler extends SetVariableMonitoringAnswer, io.u2ware.ocpp.v2_1.messaging.ChargingStationHandler {    
