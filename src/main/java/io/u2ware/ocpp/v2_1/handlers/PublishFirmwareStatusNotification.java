...
import io.u2ware.ocpp.v2_1.actions.PublishFirmwareStatusNotificationOffer;
import io.u2ware.ocpp.v2_1.actions.PublishFirmwareStatusNotificationAnswer;
...
public interface PublishFirmwareStatusNotification {
    ...
    public interface ChargingStationHandler extends PublishFirmwareStatusNotificationOffer, io.u2ware.ocpp.v2_1.messaging.ChargingStationHandler {
    ...
    public interface CSMSHandler extends PublishFirmwareStatusNotificationAnswer, io.u2ware.ocpp.v2_1.messaging.CSMSHandler {    
