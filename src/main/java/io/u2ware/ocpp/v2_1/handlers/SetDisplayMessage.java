...
import io.u2ware.ocpp.v2_1.actions.SetDisplayMessageOffer;
import io.u2ware.ocpp.v2_1.actions.SetDisplayMessageAnswer;
...
public interface SetDisplayMessage {
    ...
    public interface CSMSHandler extends SetDisplayMessageOffer, io.u2ware.ocpp.v2_1.messaging.CSMSHandler {

        default String[] features() { return new String[]{"SetDisplayMessage"};}
    ...
    public interface ChargingStationHandler extends SetDisplayMessageAnswer, io.u2ware.ocpp.v2_1.messaging.ChargingStationHandler {    
