...
import io.u2ware.ocpp.v2_1.actions.GetVariablesOffer;
import io.u2ware.ocpp.v2_1.actions.GetVariablesAnswer;
...
public interface GetVariables {
    ...
    public interface CSMSHandler extends GetVariablesOffer, io.u2ware.ocpp.v2_1.messaging.CSMSHandler {

        default String[] features() { return new String[]{"GetVariables"};}
    ...
    public interface ChargingStationHandler extends GetVariablesAnswer, io.u2ware.ocpp.v2_1.messaging.ChargingStationHandler {    
