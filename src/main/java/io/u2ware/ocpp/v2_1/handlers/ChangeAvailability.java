...
import io.u2ware.ocpp.v2_1.actions.ChangeAvailabilityOffer;
import io.u2ware.ocpp.v2_1.actions.ChangeAvailabilityAnswer;
...
public interface ChangeAvailability {
    ...
    public interface CSMSHandler extends ChangeAvailabilityOffer, io.u2ware.ocpp.v2_1.messaging.CSMSHandler {
    ...
    public interface ChargingStationHandler extends ChangeAvailabilityAnswer, io.u2ware.ocpp.v2_1.messaging.ChargingStationHandler {    
