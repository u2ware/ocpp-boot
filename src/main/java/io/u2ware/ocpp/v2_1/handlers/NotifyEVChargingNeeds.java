...
import io.u2ware.ocpp.v2_1.actions.NotifyEVChargingNeedsOffer;
import io.u2ware.ocpp.v2_1.actions.NotifyEVChargingNeedsAnswer;
...
public interface NotifyEVChargingNeeds {
    ...
    public interface ChargingStationHandler extends NotifyEVChargingNeedsOffer, io.u2ware.ocpp.v2_1.messaging.ChargingStationHandler {

        default String[] features() { return new String[]{"NotifyEVChargingNeeds"};}
    ...
    public interface CSMSHandler extends NotifyEVChargingNeedsAnswer, io.u2ware.ocpp.v2_1.messaging.CSMSHandler {    
