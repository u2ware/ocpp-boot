...
import io.u2ware.ocpp.v2_1.actions.SetNetworkProfileOffer;
import io.u2ware.ocpp.v2_1.actions.SetNetworkProfileAnswer;
...
public interface SetNetworkProfile {
    ...
    public interface CSMSHandler extends SetNetworkProfileOffer, io.u2ware.ocpp.v2_1.messaging.CSMSHandler {
    ...
    public interface ChargingStationHandler extends SetNetworkProfileAnswer, io.u2ware.ocpp.v2_1.messaging.ChargingStationHandler {    
