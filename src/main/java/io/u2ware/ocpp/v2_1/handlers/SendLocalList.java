...
import io.u2ware.ocpp.v2_1.actions.SendLocalListOffer;
import io.u2ware.ocpp.v2_1.actions.SendLocalListAnswer;
...
public interface SendLocalList {
    ...
    public interface CSMSHandler extends SendLocalListOffer, io.u2ware.ocpp.v2_1.messaging.CSMSHandler {
    ...
    public interface ChargingStationHandler extends SendLocalListAnswer, io.u2ware.ocpp.v2_1.messaging.ChargingStationHandler {    
