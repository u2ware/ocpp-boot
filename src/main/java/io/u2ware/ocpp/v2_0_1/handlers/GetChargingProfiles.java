...
import io.u2ware.ocpp.v2_0_1.actions.GetChargingProfilesOffer;
import io.u2ware.ocpp.v2_0_1.actions.GetChargingProfilesAnswer;
...
public interface GetChargingProfiles {
    ...
    public interface CSMSHandler extends GetChargingProfilesOffer, io.u2ware.ocpp.v2_0_1.messaging.CSMSHandler {
    ...
    public interface ChargingStationHandler extends GetChargingProfilesAnswer, io.u2ware.ocpp.v2_0_1.messaging.ChargingStationHandler {    
