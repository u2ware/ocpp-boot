...
import io.u2ware.ocpp.v2_0_1.actions.GetLogOffer;
import io.u2ware.ocpp.v2_0_1.actions.GetLogAnswer;
...
public interface GetLog {
    ...
    public interface CSMSHandler extends GetLogOffer, io.u2ware.ocpp.v2_0_1.messaging.CSMSHandler {

        default String[] features() { return new String[]{"GetLog"};}
    ...
    public interface ChargingStationHandler extends GetLogAnswer, io.u2ware.ocpp.v2_0_1.messaging.ChargingStationHandler {    
