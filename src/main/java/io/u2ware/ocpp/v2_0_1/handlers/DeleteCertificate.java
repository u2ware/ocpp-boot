...
import io.u2ware.ocpp.v2_0_1.actions.DeleteCertificateOffer;
import io.u2ware.ocpp.v2_0_1.actions.DeleteCertificateAnswer;
import io.u2ware.ocpp.v2_0_1.model.DeleteCertificateRequest;
import io.u2ware.ocpp.v2_0_1.model.DeleteCertificateResponse;
import io.u2ware.ocpp.v2_0_1.exception.ErrorCode;

public interface DeleteCertificate {

    public interface CSMSHandler extends DeleteCertificateOffer, io.u2ware.ocpp.v2_0_1.messaging.CSMSHandler {

        default String[] features() { return new String[]{"DeleteCertificate"};}
    ...
    public interface ChargingStationHandler extends DeleteCertificateAnswer, io.u2ware.ocpp.v2_0_1.messaging.ChargingStationHandler {    
