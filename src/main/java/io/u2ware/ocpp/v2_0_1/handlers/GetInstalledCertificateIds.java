...
import io.u2ware.ocpp.v2_0_1.actions.GetInstalledCertificateIdsOffer;
import io.u2ware.ocpp.v2_0_1.actions.GetInstalledCertificateIdsAnswer;
import io.u2ware.ocpp.v2_0_1.model.GetInstalledCertificateIdsRequest;
import io.u2ware.ocpp.v2_0_1.model.GetInstalledCertificateIdsResponse;
import io.u2ware.ocpp.v2_0_1.exception.ErrorCode;

public interface GetInstalledCertificateIds {

    public interface CSMSHandler extends GetInstalledCertificateIdsOffer, io.u2ware.ocpp.v2_0_1.messaging.CSMSHandler {
    ...
    public interface ChargingStationHandler extends GetInstalledCertificateIdsAnswer, io.u2ware.ocpp.v2_0_1.messaging.ChargingStationHandler {    
