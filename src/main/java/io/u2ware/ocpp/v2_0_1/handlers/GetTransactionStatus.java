...
import io.u2ware.ocpp.v2_0_1.actions.GetTransactionStatusOffer;
import io.u2ware.ocpp.v2_0_1.actions.GetTransactionStatusAnswer;
...
public interface GetTransactionStatus {
    ...
    public interface CSMSHandler extends GetTransactionStatusOffer, io.u2ware.ocpp.v2_0_1.messaging.CSMSHandler {

        default String[] features() { return new String[]{"GetTransactionStatus"};}
    ...
    public interface ChargingStationHandler extends GetTransactionStatusAnswer, io.u2ware.ocpp.v2_0_1.messaging.ChargingStationHandler {    
