...
import io.u2ware.ocpp.v2_0_1.actions.RequestStartTransactionOffer;
import io.u2ware.ocpp.v2_0_1.actions.RequestStartTransactionAnswer;
...
public interface RequestStartTransaction {
    ...
    public interface CSMSHandler extends RequestStartTransactionOffer, io.u2ware.ocpp.v2_0_1.messaging.CSMSHandler {

        default String[] features() { return new String[]{"RequestStartTransaction"};}
    ...
    public interface ChargingStationHandler extends RequestStartTransactionAnswer, io.u2ware.ocpp.v2_0_1.messaging.ChargingStationHandler {    
