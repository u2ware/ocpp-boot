...
import io.u2ware.ocpp.v2_0_1.actions.SetMonitoringLevelOffer;
import io.u2ware.ocpp.v2_0_1.actions.SetMonitoringLevelAnswer;
import io.u2ware.ocpp.v2_0_1.model.SetMonitoringLevelRequest;
import io.u2ware.ocpp.v2_0_1.model.SetMonitoringLevelResponse;
import io.u2ware.ocpp.v2_0_1.exception.ErrorCode;

public interface SetMonitoringLevel {

    public interface CSMSHandler extends SetMonitoringLevelOffer, io.u2ware.ocpp.v2_0_1.messaging.CSMSHandler {

        default String[] features() { return new String[]{"SetMonitoringLevel"};}
    ...
    public interface ChargingStationHandler extends SetMonitoringLevelAnswer, io.u2ware.ocpp.v2_0_1.messaging.ChargingStationHandler {    
