...
import io.u2ware.ocpp.v2_0_1.actions.NotifyEventOffer;
import io.u2ware.ocpp.v2_0_1.actions.NotifyEventAnswer;
import io.u2ware.ocpp.v2_0_1.model.NotifyEventRequest;
import io.u2ware.ocpp.v2_0_1.model.NotifyEventResponse;
import io.u2ware.ocpp.v2_0_1.exception.ErrorCode;

public interface NotifyEvent {

    public interface ChargingStationHandler extends NotifyEventOffer, io.u2ware.ocpp.v2_0_1.messaging.ChargingStationHandler {
    ...
    public interface CSMSHandler extends NotifyEventAnswer, io.u2ware.ocpp.v2_0_1.messaging.CSMSHandler {    
