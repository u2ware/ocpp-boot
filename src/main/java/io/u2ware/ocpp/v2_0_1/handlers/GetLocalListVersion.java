...
import io.u2ware.ocpp.v2_0_1.actions.GetLocalListVersionOffer;
import io.u2ware.ocpp.v2_0_1.actions.GetLocalListVersionAnswer;
...
public interface GetLocalListVersion {
    ...
    public interface CSMSHandler extends GetLocalListVersionOffer, io.u2ware.ocpp.v2_0_1.messaging.CSMSHandler {
    ...
    public interface ChargingStationHandler extends GetLocalListVersionAnswer, io.u2ware.ocpp.v2_0_1.messaging.ChargingStationHandler {    
