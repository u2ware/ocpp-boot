...
import io.u2ware.ocpp.v2_0_1.actions.GetReportOffer;
import io.u2ware.ocpp.v2_0_1.actions.GetReportAnswer;
...
public interface GetReport {
    ...
    public interface CSMSHandler extends GetReportOffer, io.u2ware.ocpp.v2_0_1.messaging.CSMSHandler {

        default String[] features() { return new String[]{"GetReport"};}
    ...
    public interface ChargingStationHandler extends GetReportAnswer, io.u2ware.ocpp.v2_0_1.messaging.ChargingStationHandler {    
