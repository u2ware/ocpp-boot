...
import io.u2ware.ocpp.v2_0_1.actions.GetCertificateStatusOffer;
import io.u2ware.ocpp.v2_0_1.actions.GetCertificateStatusAnswer;
import io.u2ware.ocpp.v2_0_1.model.GetCertificateStatusRequest;
import io.u2ware.ocpp.v2_0_1.model.GetCertificateStatusResponse;
import io.u2ware.ocpp.v2_0_1.exception.ErrorCode;

public interface GetCertificateStatus {

    public interface ChargingStationHandler extends GetCertificateStatusOffer, io.u2ware.ocpp.v2_0_1.messaging.ChargingStationHandler {

        default String[] features() { return new String[]{"GetCertificateStatus"};}
    ...
    public interface CSMSHandler extends GetCertificateStatusAnswer, io.u2ware.ocpp.v2_0_1.messaging.CSMSHandler {    
