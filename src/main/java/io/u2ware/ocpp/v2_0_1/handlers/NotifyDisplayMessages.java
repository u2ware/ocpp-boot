...
import io.u2ware.ocpp.v2_0_1.actions.NotifyDisplayMessagesOffer;
import io.u2ware.ocpp.v2_0_1.actions.NotifyDisplayMessagesAnswer;
...
public interface NotifyDisplayMessages {
    ...
    public interface ChargingStationHandler extends NotifyDisplayMessagesOffer, io.u2ware.ocpp.v2_0_1.messaging.ChargingStationHandler {

        default String[] features() { return new String[]{"NotifyDisplayMessages"};}
    ...
    public interface CSMSHandler extends NotifyDisplayMessagesAnswer, io.u2ware.ocpp.v2_0_1.messaging.CSMSHandler {    
