...
import io.u2ware.ocpp.v2_0_1.actions.ClearVariableMonitoringOffer;
import io.u2ware.ocpp.v2_0_1.actions.ClearVariableMonitoringAnswer;
...
public interface ClearVariableMonitoring {
    ...
    public interface CSMSHandler extends ClearVariableMonitoringOffer, io.u2ware.ocpp.v2_0_1.messaging.CSMSHandler {
    ...
    public interface ChargingStationHandler extends ClearVariableMonitoringAnswer, io.u2ware.ocpp.v2_0_1.messaging.ChargingStationHandler {    
