...
import io.u2ware.ocpp.v2_0_1.actions.InstallCertificateOffer;
import io.u2ware.ocpp.v2_0_1.actions.InstallCertificateAnswer;
...
public interface InstallCertificate {
    ...
    public interface CSMSHandler extends InstallCertificateOffer, io.u2ware.ocpp.v2_0_1.messaging.CSMSHandler {

        default String[] features() { return new String[]{"InstallCertificate"};}
    ...
    public interface ChargingStationHandler extends InstallCertificateAnswer, io.u2ware.ocpp.v2_0_1.messaging.ChargingStationHandler {    
