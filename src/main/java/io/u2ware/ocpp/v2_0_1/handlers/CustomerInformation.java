...
import io.u2ware.ocpp.v2_0_1.actions.CustomerInformationOffer;
import io.u2ware.ocpp.v2_0_1.actions.CustomerInformationAnswer;
import io.u2ware.ocpp.v2_0_1.model.CustomerInformationRequest;
import io.u2ware.ocpp.v2_0_1.model.CustomerInformationResponse;
import io.u2ware.ocpp.v2_0_1.exception.ErrorCode;

public interface CustomerInformation {

    public interface CSMSHandler extends CustomerInformationOffer, io.u2ware.ocpp.v2_0_1.messaging.CSMSHandler {
    ...
    public interface ChargingStationHandler extends CustomerInformationAnswer, io.u2ware.ocpp.v2_0_1.messaging.ChargingStationHandler {    
